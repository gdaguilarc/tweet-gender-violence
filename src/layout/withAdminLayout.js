            ...
            >
              <Row>
                <Col lg={!topMenu ? 4 : 3} sm={6} xs={12} className="align-center-v navbar-brand">
                  ...
                  >
                    <img
                      src={!darkMode ? require(`../static/img/Logo_Dark.png`) : require(`../static/img/Logo_white.png`)}
                      alt="logo nice-bot"
                    />
                  </Link>
                </Col>
              ...
              <Layout className="atbd-main-layout">
                <Content>
                  ...
                  <Footer className="admin-footer" style={footerStyle}>
                    <Row>
                      <Col md={12} xs={24}>
                        <span className="admin-footer__copyright">2020 © Tecnológico de Monterrey</span>
                      </Col>
                      <Col md={12} xs={24}>

            ...
            <ComingsoonStyleWrapper>
              <Cards headless>
                <div className="strikingDash-logo">
                  <img style={{ width: '120px' }} src={require('../../static/img/Logo_Dark.png')} alt="" />
                </div>
                <div className="coming-soon-content">
                  <h1>Estamos trabajando en más herramientas</h1>
                  <p>Si quieres conocer más de este proyecto manda un e-mail a gd.aguilarc@gmail.com</p>
                </div>
                ...
                <div className="coming-soon-social">
                  ...
                  <p>2020 © Tecnológico de Monterrey</p>
                </div>
              </Cards>
            </ComingsoonStyleWrapper>
          </Col>
